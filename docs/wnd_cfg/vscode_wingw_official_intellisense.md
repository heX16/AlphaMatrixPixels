...
source: "https://code.visualstudio.com/docs/languages/cpp#_intellisense-configuration"
author:
  - "[[Microsoft]]"
...
Now press Ctrl+S to save the file. You can also enable [AutoSave](https://code.visualstudio.com/docs/editing/codebasics#_save--auto-save) to automatically save your file changes, by checking **Auto Save** in the main **File** menu.
